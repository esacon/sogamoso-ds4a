          ...
          <CCardBody>
            <CForm>
              <CRow>
                ...
                <CCol lg={6}>
                  <CFormLabel htmlFor="exampleFormControlInput1">Motivo</CFormLabel>
              ...
              <CRow>
                <CCol lg={6}>
                  <CFormLabel htmlFor="exampleFormControlInput1">Número Acta Control</CFormLabel>
                  <CFormInput type="text" id="exampleFormControlInput1" />
                </CCol>
                <CCol lg={6}>
                  <CFormLabel htmlFor="exampleFormControlInput1">Número acta visita</CFormLabel>
                  <CFormInput type="text" id="exampleFormControlInput1" />
                </CCol>
              </CRow>
              ...
              <CRow>
                <CCol lg={6}>
                  <CFormLabel htmlFor="exampleFormControlInput1">Número Inscripción</CFormLabel>
                  <CFormInput type="text" id="exampleFormControlInput1" />
                </CCol>
                <CCol lg={6}>
                  <CFormLabel htmlFor="exampleFormControlInput1">
              ...
              <CRow>
                <CCol lg={6}>
                  <CFormLabel htmlFor="exampleFormControlInput1">
                    Techos, puertas, iluminación y ventilación
                  </CFormLabel>
                  <CFormRange />
                </CCol>
                <CCol lg={6}>
                  <CFormLabel htmlFor="exampleFormControlInput1">
                    Condiciones pisos paredes y drenajes
                  </CFormLabel>
                  <CFormRange />
                </CCol>
              </CRow>
              ...
              <CRow>
                ...
                <CCol lg={6}>
                  <CFormLabel htmlFor="exampleFormControlInput1">Equipos y utensilios</CFormLabel>
                  <CFormRange />
                </CCol>
              </CRow>
            </CForm>
